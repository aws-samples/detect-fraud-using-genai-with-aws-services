...
class ReverseImageSearchResult(BaseModel):
    ...
    csim: Optional[Union[StrictFloat, StrictInt]] = None
    title: Optional[StrictStr] = None
    link: Optional[StrictStr] = None
    filename: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["data_url", "source", "csim", "title", "link", "filename"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if data_url (nullable) is None
        # and model_fields_set contains the field
        if self.data_url is None and "data_url" in self.model_fields_set:
            _dict['data_url'] = None
        ...
        # set to None if csim (nullable) is None
        # and model_fields_set contains the field
        if self.csim is None and "csim" in self.model_fields_set:
            _dict['csim'] = None
